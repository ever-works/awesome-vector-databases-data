...
- **Vector Search:** Supports vector search via faiss and nmslib approximate nearest neighbor engines, enabling AI and machine learning-powered applications.
- **Neural Search:** Neural search plugins for semantic retrieval and hybrid search combining dense retrieval with traditional keyword search.
...
- **AWS Ecosystem Integration:** Tight integration with Amazon OpenSearch Service and broader AWS services.
...
## Pricing
OpenSearch is free and open source, licensed under the Apache 2.0 license. Amazon OpenSearch Service offers managed hosting with pay-as-you-go pricing.