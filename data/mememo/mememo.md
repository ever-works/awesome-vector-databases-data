...
- **Easy Integration**: Install with a single command `npm install mememo` and import into any web app
- **Framework Agnostic**: Works with JavaScript, TypeScript, React, Svelte, or Lit
