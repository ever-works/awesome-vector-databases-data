...
1. **Storage Layer**: Leverages distributed storage networks (DSNs) for scalable data persistence
2. **Indexing Layer**: Utilizes distributed Approximate Nearest Neighbors (ANN) indexing, primarily HNSW
3. **Query Processing Layer**: Provides interface for efficient search and retrieval
