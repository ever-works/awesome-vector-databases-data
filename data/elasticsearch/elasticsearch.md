...
[Elasticsearch](https://www.elastic.co/elasticsearch/) is an open source, distributed, RESTful search and analytics engine, scalable data store, and vector database. It is at the core of the Elastic Stack and is widely used for a range of search, analytics, and monitoring applications.
